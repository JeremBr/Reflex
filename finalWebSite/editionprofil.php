...
if(isset($_COOKIE['idUtilisateur']) AND isset($_COOKIE['mdp'])) { //IL FAUT METTRE UNE VERIF QUE C LE BON MDP, POUR EVITER USURPATION COOKIE
...
<html>
   <head>
      ...
      <!--POUR APPLIQUER CSS IL FAUT ENLEVER LE STYLE.CSS DU HEADER ET DONC REGARDER QUE CA NIMPACT PAS LES AUTRES PAGES-->
   </head>
   <body>
